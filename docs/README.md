...
![The DAO stack](img/the-dao-stack.png)

The DAO stack:

1. [Ethereum](https://www.ethereum.org/) - *Base blockchain.*
2. **Arc - This project**
3. The ArcHives - *A public curated database of [element](#elements)s, organizations and a shared place for community collaboration*.
4. [Arc.js](https://github.com/daostack/arc.js) - *JavaScript library that interfaces with Arc, built on top of web3.js.*
...
* **[Reputation](generated_docs/controller/Reputation.md) system** - *Similar to native token but is **non-transferable**. The reputation  system is used to assign weight to the votes of participants*.
* **[Avatar](generated_docs/controller/Avatar.md)** - *This is the public-facing part of the DAO that handles the interaction of the DAO with the rest of the world (e.g. interacting with other DAOs, paying third-party participants, etc...)*.
...
For each DAO, the above components are organized in a single smart contract called a *[Controller](Controller)*.

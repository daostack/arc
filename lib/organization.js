...
export class Organization {
  ...
  async proposeScheme(opts={}) {
    ...
    if (options.schemeType === 'SimpleICO') {
      ...
      // get the scheme
      const scheme = await SimpleContributionScheme.at(settings.contributionScheme);
      ...
      const parametersHash = await scheme.getParametersHash(orgNativeTokenFee, voteApproveParams, schemeNativeTokenFee, options.boolVote);
      await scheme.setParameters(orgNativeTokenFee, voteApproveParams, schemeNativeTokenFee, options.boolVote);

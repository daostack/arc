...
const GenesisScheme = artifacts.require("GenesisScheme");
...
const SimpleContributionScheme = artifacts.require("SimpleContributionScheme");
const SimpleICO = artifacts.require("SimpleICO");
const SimpleVote = artifacts.require("SimpleVote");
const TokenCapGC = artifacts.require("TokenCapGC");

...
const daostack = (function() {
    ...
    async function forgeOrganization(
        ...
        const schemeGCRegisterParams = await globalConstraintRegistrarInst.parametersHash(voteParametersHash, simpleVoteInst.address);
        const schemeUpgradeParams = await upgradeSchemeInst.parametersHash(voteParametersHash, simpleVoteInst.address);
        ...
        await schemeRegistrarInst.addOrUpdateOrg(avatar.address, voteParametersHash, voteParametersHash, simpleVoteInst.address);
        await globalConstraintRegistrarInst.addOrUpdateOrg(avatar.address, voteParametersHash, simpleVoteInst.address);
        await upgradeSchemeInst.addOrUpdateOrg(avatar.address, voteParametersHash, simpleVoteInst.address);

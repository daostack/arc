...
contract SchemeRegistrar is UniversalScheme {
  ...
  event LogRemoveSchemeProposal(address indexed _avatar,bytes32 indexed _proposalId, address indexed _intVoteInterface, address _scheme);
  ...
  ) returns(bytes32)
  {
    ...
    LogNewSchemeProposal(_avatar, proposalId, controllerParams.intVote, _scheme, _parametersHash, _isRegistering, _tokenFee, _fee, _autoRegister);

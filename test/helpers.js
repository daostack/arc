...
const CL4RRedeemer = artifacts.require("./CL4RRedeemer.sol");
...
const SOME_ADDRESS = '0x1000000000000000000000000000000000000000';
 ...
 const registrationAddVersionToPackege = async function (registration,version = [0,1,0]) {
  ...
  registration.cL4RRedeemer = await CL4RRedeemer.new();
  ...
  registration.join = await Join.new();
  ...
  await implementationDirectory.setImplementation("CL4RRedeemer",registration.cL4RRedeemer.address);
  ...
  await implementationDirectory.setImplementation("Join",registration.join.address);
